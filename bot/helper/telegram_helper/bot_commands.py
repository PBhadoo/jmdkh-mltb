...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = [f'qbmirrorDISABLED{CMD_SUFFIX}', f'qmDISABLED{CMD_SUFFIX}']
        self.QbUnzipMirrorCommand = [f'qbunzipmirrorDISABLED{CMD_SUFFIX}', f'quzmDISABLED{CMD_SUFFIX}']
        self.QbZipMirrorCommand = [f'qbzipmirrorDISABLED{CMD_SUFFIX}', f'qzmDISABLED{CMD_SUFFIX}']
        ...
        self.QbLeechCommand = [f'qbleechDISABLED{CMD_SUFFIX}', f'qlDISABLED{CMD_SUFFIX}']
        self.QbUnzipLeechCommand = [f'qbunzipleechDISABLED{CMD_SUFFIX}', f'quzlDISABLED{CMD_SUFFIX}']
        self.QbZipLeechCommand = [f'qbzipleechDISABLED{CMD_SUFFIX}', f'qzlDISABLED{CMD_SUFFIX}']
